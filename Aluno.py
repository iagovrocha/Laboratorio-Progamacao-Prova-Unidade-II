...
class Aluno(Pessoa):
    def __init__(self, sistema: Sistema, nome: str, rg: str, cpf: str, anoNasc: int, mesNasc: int,
        ...
        # O Aluno é cadastrado no sistema assim que é instanciado,
        # seguindo o padrão das classes Funcionario e CoordenadorAdm.
        sistema.cadastrarAluno(self) # Isso pressupõe um método 'cadastrarAluno' em Sistema.
